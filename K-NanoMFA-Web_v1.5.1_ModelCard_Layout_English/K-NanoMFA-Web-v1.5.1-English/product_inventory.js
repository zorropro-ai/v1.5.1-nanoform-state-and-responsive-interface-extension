...
function initUI(appApi){
  ...
  document.getElementById('exportProductInventoryBtn')?.addEventListener('click',()=>app.download('K-NanoMFA_product_inventory_v15.json',JSON.stringify(getState(),null,2),'application/json'));
