(function(root,factory){
  ...
  function exportCurrent(){const def=getDefinition(value('customGeoCode'));if(!def){alert('Save the custom geography before exporting it.');return;}download(`K-NanoMFA_${def.code}_custom_geography_v15.json`,JSON.stringify(def,null,2));}
